...
In this case, you need to use your own MongoDB database; you can get a free one by follow the instructions in our [Intro Lab](https://mongodb-developer.github.io/intro-lab/docs/category/mongodb-atlas)
:::
