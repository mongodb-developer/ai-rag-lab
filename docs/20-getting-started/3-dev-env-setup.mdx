...
<details>
  <summary>🦹 If you are doing this lab as part of a MongoDB GenAI Developer Day, you can continue in the Codespace you previously created.</summary>
    ...
    <Screenshot url="https://github.com/codespaces" src="img/screenshots/20-getting-started/3-dev-env-setup/1-resume-codespace.png" alt="Resume codespace" />
    ...
    <Screenshot url="https://github.com/codespaces" src="img/screenshots/20-getting-started/3-dev-env-setup/3-nav-notebook.png" alt="Navigate to the notebook" />
</details>
...
<Screenshot url="https://github.com/codespaces" src="img/screenshots/20-getting-started/3-dev-env-setup/2-create-codespace.png" alt="Start a codespace" />
...
<Screenshot url="https://github.com/codespaces" src="img/screenshots/20-getting-started/3-dev-env-setup/4-select-kernel.png" alt="Select kernel" />
...
<Screenshot url="https://github.com/codespaces" src="img/screenshots/20-getting-started/3-dev-env-setup/5-python-env-modal.png" alt="Select Python Environments" />

<Screenshot url="https://github.com/codespaces" src="img/screenshots/20-getting-started/3-dev-env-setup/6-select-recommended.png" alt="Select recommended interpreter" />
...
<Screenshot url="localhost:8888/tree" src="img/screenshots/20-getting-started/3-dev-setup/7-jupyter-notebook.png" alt="Jupyter Notebook" />