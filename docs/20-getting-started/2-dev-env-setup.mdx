...
:::tip
In this lab, we will be using Jupyter Notebooks, which is an interactive Python environment. If you are new to Jupyter Notebooks, use [this](https://mongodb-developer.github.io/vector-search-lab/docs/getting-started/jupyter-notebooks) guide to familiarize yourself with this environment.
:::
...
<Screenshot url="https://github.com/codespaces" src="img/screenshots/20-getting-started/2-dev-env-setup/2-create-codespace.png" alt="Start a codespace" />
