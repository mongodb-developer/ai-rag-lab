...
Fill in any `<CODE_BLOCK_N>` placeholders and run the cells under the **Step 4: Ingest data into MongoDB** section in the notebook to ingest the embedded documents into MongoDB.
